  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center p-0 md:p-4">
      ...
      <div className="relative w-full h-[100dvh] md:h-[700px] max-w-[90rem] bg-white dark:bg-[#0a0a0a] border-0 md:border border-neutral-200 dark:border-white/10 rounded-none md:rounded-[2.5rem] shadow-2xl animate-in slide-in-from-bottom-10 md:zoom-in-95 duration-300 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
        ...
        <div className="w-full md:w-[25%] bg-neutral-100 dark:bg-[#121212] border-b md:border-b-0 md:border-r border-neutral-200 dark:border-white/5 flex flex-col relative shrink-0 h-auto md:h-full md:overflow-y-auto">
            {/* Decor */}
            ...
            <div className="p-8 flex-1 flex flex-col">
                ...
                <div className="mb-8 pt-6 md:pt-0">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center text-neutral-900 dark:text-white mb-6 shadow-[0_0_20px_rgba(236,72,153,0.3)]">
                ...
                <div className="space-y-6 mt-2">
                    <div className="flex items-start gap-4">
                        <div className="w-10 h-10 rounded-full bg-neutral-100 dark:bg-[#1a1a1a] flex items-center justify-center text-yellow-500 shrink-0 border border-neutral-200 dark:border-white/5">
                            <Cake size={18} />
                        </div>
                        <div>
                            <h4 className="text-neutral-900 dark:text-white font-bold text-sm">Delicious Menu</h4>
                            <p className="text-neutral-500 text-xs mt-1">Curated deals for every party size.</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="w-10 h-10 rounded-full bg-neutral-100 dark:bg-[#1a1a1a] flex items-center justify-center text-pink-500 shrink-0 border border-neutral-200 dark:border-white/5">
                            <Music size={18} />
                        </div>
                        <div>
                            <h4 className="text-neutral-900 dark:text-white font-bold text-sm">Great Ambiance</h4>
                            <p className="text-neutral-500 text-xs mt-1">Perfect spots for friends & family.</p>
                        </div>
                    </div>
                     <div className="flex items-start gap-4">
                        <div className="w-10 h-10 rounded-full bg-neutral-100 dark:bg-[#1a1a1a] flex items-center justify-center text-purple-500 shrink-0 border border-neutral-200 dark:border-white/5">
                            <Sparkles size={18} />
                        </div>
                        <div>
                            <h4 className="text-neutral-900 dark:text-white font-bold text-sm">Hassle Free</h4>
                ...
                <div className="mt-auto pt-8 border-t border-neutral-200 dark:border-white/5">
                    ...
                    <a href="tel:111339339" className="flex items-center gap-3 text-neutral-900 dark:text-white hover:text-yellow-500 transition-colors group">
        ...
        <div className="w-full md:flex-1 bg-white dark:bg-[#0a0a0a] flex flex-col relative h-auto md:h-full md:overflow-y-auto">
            ...
            <div className="flex-1 p-6 md:p-8">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-10">
                        <h3 className="text-xl font-bold text-neutral-900 dark:text-white uppercase tracking-tight mb-6 flex items-center gap-2">
                                ...
                                return (
                                    <div 
                                        ...
                                        className={`
                                            ...
                                            ${isSelected 
                                                ? 'border-yellow-500 bg-white dark:bg-[#161616] shadow-[0_0_20px_rgba(234,179,8,0.2)]' 
                                                : 'border-neutral-200 dark:border-white/5 bg-neutral-100 dark:bg-[#121212] hover:border-white/20 hover:bg-white dark:bg-[#161616]'}
                                        `}
                                    >
                                        <div className="relative h-32 md:h-40 w-full overflow-hidden">
                                            ...
                                            <div className="absolute bottom-3 left-3 right-3 flex justify-between items-end">
                                                <span className="font-black text-sm md:text-lg text-neutral-900 dark:text-white uppercase">{deal.name}</span>
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        <input type="number" value={noofPerson} onChange={(e) => setNoofPerson(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="Total Persons" required />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        <input type="datetime-local" value={dateTime} onChange={(e) => setDateTime(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-500 dark:placeholder:text-neutral-700 [color-scheme:dark]" required />
                                    </div>
                                </div>
                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Event Location *</label>
                                    <div className="relative">
                                        <input type="text" value={location} onChange={(e) => setLocation(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="e.g. Broadway Pizza Johar Town" required />
                            ...
                            <div className="space-y-1.5">
                                ...
                                <textarea rows={3} value={instructions} onChange={(e) => setInstructions(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm resize-none placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="Any specific requirements regarding decor, food, or seating?" />
                            </div>
