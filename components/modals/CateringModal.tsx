      ...
      <div className="relative w-full h-[100dvh] md:h-[680px] max-w-4xl bg-white dark:bg-[#0a0a0a] border-0 md:border border-neutral-200 dark:border-white/10 rounded-none md:rounded-[2.5rem] shadow-2xl animate-in slide-in-from-bottom-10 md:zoom-in-95 duration-300 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
        ...
        <div className="w-full md:w-[36%] bg-neutral-100 dark:bg-[#121212] border-b md:border-b-0 md:border-r border-neutral-200 dark:border-white/5 flex flex-col p-8">
          <div className="pt-6 md:pt-0">
            ...
            <h2 className="text-3xl font-black text-neutral-900 dark:text-white uppercase tracking-tight leading-none mb-3">Catering<br/>Services</h2>
          ...
          <div className="mt-auto pt-8 border-t border-neutral-200 dark:border-white/5">
            <a href="downloads/CateringMenu.pdf" target="_blank" rel="noreferrer" className="w-full inline-flex items-center justify-center rounded-xl bg-neutral-200 hover:bg-neutral-300 dark:bg-white/10 dark:hover:bg-white/15 text-neutral-900 dark:text-white text-sm font-bold py-3 transition-colors border border-neutral-200 dark:border-white/10">
        ...
        <div className="w-full md:flex-1 bg-white dark:bg-[#0a0a0a] flex flex-col relative h-auto md:h-full md:overflow-y-auto">
          ...
          <div className="flex-1 p-8">
            <div className="max-w-2xl mx-auto">
              <h3 className="text-xl font-bold text-neutral-900 dark:text-white uppercase tracking-tight mb-2">Tell us about your event</h3>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-1.5">
                    ...
                    <input type="datetime-local" value={dateTime} onChange={(e) => setDateTime(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm [color-scheme:dark]" required />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Event Location *</label>
                    <input type="text" value={location} onChange={(e) => setLocation(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="Type your location here" required />
                  </div>
                </div>

                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Special Instructions</label>
                  <textarea rows={3} value={instructions} onChange={(e) => setInstructions(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm resize-none placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="Type your message here" />
                </div>
