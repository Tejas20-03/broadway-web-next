    ...
    <div className="fixed inset-0 z-[120] flex items-end md:items-center justify-center">
      ...
      <div className="relative w-full h-[100dvh] md:h-[600px] md:max-w-md bg-white dark:bg-[#0a0a0a] rounded-none md:rounded-3xl shadow-2xl flex flex-col overflow-hidden border-0 md:border border-neutral-200 dark:border-white/10 animate-in slide-in-from-bottom-10 md:zoom-in-95 duration-300">
        ...
        <div className="flex items-center justify-between p-5 border-b border-neutral-200 dark:border-white/5 bg-neutral-100 dark:bg-[#121212] shrink-0 pt-safe-top">
            <h2 className="text-xl font-black text-neutral-900 dark:text-white tracking-tight">Select City</h2>
            <button 
                onClick={onClose}
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    {/* City Image */}
                                    <div className="w-10 h-10 rounded-lg overflow-hidden shrink-0 border border-neutral-200 dark:border-white/10 bg-neutral-900 relative">
                                        {city.imageUrl ? (
                                            <Image
                                                src={city.imageUrl}
                                                alt={city.name}
                                    ...
                                    <span className={`font-bold text-sm md:text-base tracking-tight ${isSelected ? 'text-neutral-900 dark:text-white' : 'text-neutral-400 group-hover:text-neutral-900 dark:text-white'} transition-colors`}>
                                        {city.name}
                                    </span>
                                </div>
