...
export const CorporateModal: React.FC<CorporateModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center p-0 md:p-4">
      ...
      <div className="relative w-full h-[100dvh] md:h-[640px] max-w-4xl bg-[#0a0a0a] border-0 md:border border-white/10 rounded-none md:rounded-[2.5rem] shadow-2xl animate-in slide-in-from-bottom-10 md:zoom-in-95 duration-300 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
        ...
        <div className="w-full md:w-[36%] bg-[#121212] border-b md:border-b-0 md:border-r border-white/5 flex flex-col p-8">
          <div className="pt-6 md:pt-0">
            ...
            <h2 className="text-3xl font-black text-white uppercase tracking-tight leading-none mb-3">Corporate<br/>Alliances</h2>
          ...
          <div className="mt-auto pt-8 border-t border-white/5">
            <a href="downloads/CorporateMenu.pdf" target="_blank" rel="noreferrer" className="w-full inline-flex items-center justify-center rounded-xl bg-white/10 hover:bg-white/15 text-white text-sm font-bold py-3 transition-colors border border-white/10">
        ...
        <div className="w-full md:flex-1 bg-[#0a0a0a] flex flex-col relative h-auto md:h-full md:overflow-y-auto">
          ...
          <div className="flex-1 p-8">
            <div className="max-w-2xl mx-auto">
              <h3 className="text-xl font-bold text-white uppercase tracking-tight mb-2">Send your message</h3>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input type="text" value={organization} onChange={(e) => setOrganization(e.target.value)} className="w-full bg-[#161616] border border-white/10 rounded-xl px-4 py-3 text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-700" placeholder="Company name" required />
                  </div>
                </div>

                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Your Requirements / Queries</label>
                  <textarea rows={4} value={query} onChange={(e) => setQuery(e.target.value)} className="w-full bg-[#161616] border border-white/10 rounded-xl px-4 py-3 text-white focus:border-yellow-500 outline-none transition-colors text-sm resize-none placeholder:text-neutral-700" placeholder="Type your query here" />
                </div>
