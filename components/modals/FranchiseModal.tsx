  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center p-0 md:p-4">
      ...
      <div className="relative w-full h-[100dvh] md:h-[700px] max-w-5xl bg-white dark:bg-[#0a0a0a] border-0 md:border border-neutral-200 dark:border-white/10 rounded-none md:rounded-[2.5rem] shadow-2xl animate-in slide-in-from-bottom-10 md:zoom-in-95 duration-300 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
        ...
        {/* Left Panel: Info */}
        <div className="w-full md:w-[35%] bg-neutral-100 dark:bg-[#121212] border-b md:border-b-0 md:border-r border-neutral-200 dark:border-white/5 flex flex-col relative shrink-0 h-auto md:h-full md:overflow-y-auto">
             {/* Decor */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-yellow-500/5 rounded-full blur-[80px] pointer-events-none"></div>
             ...
             <div className="p-8 flex-1 flex flex-col">
                <div className="mb-8 pt-6 md:pt-0">
                    ...
                    <h2 className="text-3xl font-black text-neutral-900 dark:text-white uppercase tracking-tight leading-none mb-3">
                        Partner<br/>With Us
                    </h2>
                ...
                <div className="space-y-6 mt-4">
                    <div className="flex items-start gap-4">
                        <div className="w-8 h-8 rounded-full bg-neutral-100 dark:bg-[#1a1a1a] flex items-center justify-center text-yellow-500 shrink-0 border border-neutral-200 dark:border-white/5">
                            <Building2 size={16} />
                        </div>
                        <div>
                            <h4 className="text-neutral-900 dark:text-white font-bold text-sm">Proven Business Model</h4>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h4 className="text-neutral-900 dark:text-white font-bold text-sm">Comprehensive Support</h4>
                ...
                <div className="mt-auto pt-8 border-t border-neutral-200 dark:border-white/5">
                    ...
                    <p className="text-neutral-900 dark:text-white font-bold text-sm">franchise@broadwaypizza.com.pk</p>
                </div>
            </div>
        </div>
        ...
        <div className="w-full md:flex-1 bg-white dark:bg-[#0a0a0a] flex flex-col relative h-auto md:h-full md:overflow-y-auto">
            ...
            <div className="flex-1 p-8">
                 <div className="max-w-2xl mx-auto">
                    <h3 className="text-xl font-bold text-neutral-900 dark:text-white uppercase tracking-tight mb-2">Franchise Application</h3>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="space-y-1.5">
                                ...
                                <input type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="Full Name" required />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Phone Number *</label>
                                <input type="tel" value={contact} onChange={(e) => setContact(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="0300..." />
                            </div>
                        </div>
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="space-y-1.5">
                                ...
                                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="email@example.com" />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Current Occupation *</label>
                                <input type="text" value={occupation} onChange={(e) => setOccupation(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="Business / Job Title" required />
                            </div>
                        </div>
                        ...
                        {/* Location & Experience */}
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="space-y-1.5">
                                ...
                                <input type="text" value={city} onChange={(e) => setCity(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="Which city?" required />
                            </div>
                             <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Other Franchises? *</label>
                                <input type="text" value={ownOtherFranchises} onChange={(e) => setOwnOtherFranchises(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="Yes/No (Specify name)" required />
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                             ...
                             <div className="flex gap-4">
                                <label className="flex items-center gap-2 cursor-pointer group">
                                    ...
                                    <span className="text-sm text-neutral-900 dark:text-white">Yes</span>
                                </label>
                                <label className="flex items-center gap-2 cursor-pointer group">
                                    <div className="w-5 h-5 rounded-full border border-white/20 group-hover:border-yellow-500 flex items-center justify-center">
                                    ...
                                    <span className="text-sm text-neutral-900 dark:text-white">No</span>
                                </label>
                             </div>
                        </div>
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Investment Capital *</label>
                                                                <select value={totalLiquidAssets} onChange={(e) => setTotalLiquidAssets(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm appearance-none cursor-pointer">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Heard About Us Via *</label>
                                                                <select value={hearAbout} onChange={(e) => setHearAbout(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm appearance-none cursor-pointer">
                        ...
                        <div className="space-y-1.5">
                             <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Office Address *</label>
                                                         <textarea rows={3} value={regions} onChange={(e) => setRegions(e.target.value)} className="w-full bg-white dark:bg-[#161616] border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-3 text-neutral-900 dark:text-white focus:border-yellow-500 outline-none transition-colors text-sm resize-none placeholder:text-neutral-500 dark:placeholder:text-neutral-700" placeholder="Your office address" required />
                        </div>
