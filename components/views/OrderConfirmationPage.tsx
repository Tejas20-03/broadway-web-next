...
export const OrderConfirmationPage: React.FC<OrderConfirmationPageProps> = ({
  ...
  if (phase === 'rejected') {
    return (
    <div className="fixed inset-0 z-[500] bg-gray-50 dark:bg-[#050505] flex flex-col items-center justify-center p-6">
        {toastEl}
  ...
  return (
    <div className="fixed inset-0 z-[500] bg-gray-50 dark:bg-[#050505] overflow-y-auto animate-in zoom-in-95 duration-500 custom-scrollbar flex flex-col items-center">
      {toastEl}
      ...
      <div className="w-full max-w-5xl px-4 py-8 md:py-12 relative z-10 flex flex-col flex-grow">
        ...
        <div className="text-center mb-12 animate-in slide-in-from-bottom-5 duration-700 delay-100">
            <div className="w-24 h-24 md:w-32 md:h-32 bg-neutral-100 dark:bg-[#1a1a1a] rounded-full mx-auto mb-6 flex items-center justify-center border-4 border-neutral-300 dark:border-[#222] shadow-[0_0_40px_rgba(234,179,8,0.2)] relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 animate-in slide-in-from-bottom-5 duration-700 delay-200">
            {/* Order # */}
            <div className="bg-white dark:bg-[#121212] border border-neutral-200 dark:border-white/5 rounded-2xl p-5 flex flex-col items-center justify-center text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 animate-in slide-in-from-bottom-5 duration-700 delay-300">
            ...
            <div className="lg:col-span-3 space-y-6">
                ...
                {/* Progress Tracker */}
                <div className="bg-white dark:bg-[#121212] border border-neutral-200 dark:border-white/5 rounded-3xl p-6 md:p-8">
                    ...
                    <div className="relative flex justify-between px-2">
                        <div className="absolute top-[14px] left-0 w-full h-1 bg-neutral-300 dark:bg-[#222] rounded-full z-0"></div>
                        <div
                        ...
                        <div className={`relative z-10 flex flex-col items-center gap-2 transition-opacity ${phase === 'preparing' || phase === 'onTheWay' || phase === 'delivered' ? 'opacity-100' : 'opacity-30'}`}>
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${
                                phase === 'preparing' || phase === 'onTheWay' || phase === 'delivered'
                                    ...
                                    : 'bg-neutral-100 dark:bg-[#1a1a1a] border-neutral-300 dark:border-[#333]'
                            }`}>
                        ...
                        <div className={`relative z-10 flex flex-col items-center gap-2 transition-opacity ${phase === 'delivered' ? 'opacity-100' : 'opacity-30'}`}>
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                                phase === 'delivered'
                                    ...
                                    : 'bg-neutral-100 dark:bg-[#1a1a1a] border-2 border-neutral-300 dark:border-[#333]'
                            }`}>
                                {phase === 'delivered'
                                    ? <Check size={16} className="text-black" strokeWidth={4} />
                     ...
                     <div className="space-y-6">
                        {isPickup ? (
                          <div className="flex items-start gap-4">
                            <div className="w-10 h-10 rounded-xl bg-neutral-100 dark:bg-[#1a1a1a] flex items-center justify-center text-yellow-500 shrink-0">
                                <ShoppingBag size={20} />
                            </div>
                            <div>
            ...
            <div className="lg:col-span-2">
                <div className="bg-white dark:bg-[#121212] border border-neutral-200 dark:border-white/5 rounded-3xl overflow-hidden flex flex-col h-full">
                    <div className="p-6 border-b border-neutral-200 dark:border-white/5 bg-neutral-100 dark:bg-[#161616] flex items-center justify-between">
                            ...
                            <div className="space-y-4 animate-pulse">
                                {[1,2,3].map(i => (
                                    <div key={i} className="flex gap-3">
                                        <div className="w-10 h-10 rounded-lg bg-neutral-200 dark:bg-[#1a1a1a] shrink-0" />
                                        <div className="flex-1 space-y-2 py-1">
                                            <div className="h-2 bg-neutral-200 dark:bg-[#1a1a1a] rounded w-3/4" />
                                            <div className="h-2 bg-neutral-200 dark:bg-[#1a1a1a] rounded w-1/2" />
                                        </div>
                                    </div>
                                ))}
                            </div>
