      ...
      >
          {categories.map((cat) => (
            <button
              ...
              className={`
                whitespace-nowrap px-4 py-2 md:px-6 md:py-2.5 rounded-full text-xs md:text-sm font-bold transition-all duration-300 ease-out flex-shrink-0 border inline-flex items-center gap-2
